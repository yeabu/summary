...
// PurchaseParamGet 获取商品采购参数
func PurchaseParamGet(w http.ResponseWriter, r *http.Request) {
...
// PurchaseParamUpsert 新增或更新商品采购参数（管理员/基地代理）
func PurchaseParamUpsert(w http.ResponseWriter, r *http.Request) {
...
// PurchaseParamDelete 删除采购参数（管理员）
func PurchaseParamDelete(w http.ResponseWriter, r *http.Request) {
    claims, err := middleware.ParseJWT(r); if err != nil { http.Error(w, "未授权", http.StatusUnauthorized); return }
