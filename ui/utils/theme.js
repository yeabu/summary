...
function lighten(hex, ratio) {
  ...
  const k = typeof ratio === 'number' ? ratio : 0.16;
...
function getThemeColor() {
  ...
  const color = app && app.globalData ? app.globalData.themeColor : null;
  return color || '#B4282D';
}

module.exports = { makeFabStyle, lighten, hexToRgb, alpha, getThemeColor };
